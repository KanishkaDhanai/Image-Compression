...
img = Image.open('sample/tiger.bmp')
...
# Save as JPEG
save_image_as_jpeg(decoded_img, 'Compressed_image.jpg')

print("Decoding has been completed: the picture is stored as Compressed_image.jpg")